		...
		<div class="payment-wrap">
			...
			<div class="payment-info-box">
				...
				<div id="divOrderInfo" class="payment-detail">
					<span class="pay-order">订单号:<%=order.getOrderId()%></span>
			...
			<div class="pay-online-box">
				...
				<div class="paybox1" id="J_bankbox">
					...
					<div class="payment-btnbox">
						<a href="<%=basePath %>servlet/OrderServlet?method=orderPay" title="确认支付" class="thickbox" type="button">确认支付</a>
					</div>
				</div>
				<!--网银支付-->
			</div>
