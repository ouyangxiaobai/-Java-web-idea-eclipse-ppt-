...
public class InsertMemberData {
	...
	// map.put("userNo", getUserNo(getTel()));
	// return map;
	// }
	public static void main(String[] args) {
		...
		String beginTime = "2016-08-01";// 假定会员注册时间
		String endTime = "2016-12-31";
		String password = "111111";// 密码为111111

		String sql = "insert into t_member(memberId,memberNo,memberPassword,memberName,memberSex,memberPhone,registerTime) "
				+ "	values(?,?,?,?,?,?,?)";

		for (int i = 0; i < 10000; i++) {
			String tel = getTel();// 电话号码
			String memberNo = getUserNo(tel);// 用户名
			String memberName = getChineseName();// 名字
			String sex = name_sex;
