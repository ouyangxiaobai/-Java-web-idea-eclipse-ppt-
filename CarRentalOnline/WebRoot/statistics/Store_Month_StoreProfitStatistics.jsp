			...
			<div id="forms" class="mt10">
				<div class="box">
					<div class="box_border">
						...
						<center>
							<form
								action="<%=basePath%>servlet/StoreProfitServlet?method=storeShowMonthStoreProfitByCondition"
								method="post">
							...
							<form
								action="<%=basePath%>servlet/StoreProfitServlet?method=storeShowDayStoreProfitByCondition"
